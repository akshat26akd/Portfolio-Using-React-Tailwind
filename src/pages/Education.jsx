        ...
        <div>
          ...
          <div>
            ...
            <div className="flex flex-col justify-between items-baseline">
              <h3 className="pt-2 text-1xl font-normal text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-blue-400">
                2019 - Present
              </h3>
              <h3 className="pt-1 text-1xl font-normal text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-blue-400">
                8.0 C.G.P.A
              </h3>
            </div>
          </div>
